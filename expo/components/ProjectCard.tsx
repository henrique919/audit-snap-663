...
const styles = StyleSheet.create({
  ...
  titleWrap: { flex: 1 },
  name: { fontSize: font.size.lg, fontWeight: font.weight.bold, color: palette.text },
  ...
  statDate: { fontSize: font.size.sm, fontWeight: font.weight.bold, color: palette.text, marginTop: 2 },
  statLbl: {
    fontSize: 10,
